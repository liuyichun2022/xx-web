<template>
  <div class="app-container">
    ...
    <el-card class="operate-container" shadow="never" label-width="120px">
      <el-form :model="newsParam"  ref="newsFrom">
        <el-form-item label="新闻标题：" prop="title">
          <el-input v-model="newsParam.title" :disabled="true"></el-input>
        </el-form-item>
        <el-form-item label="封面：" prop="coverImg">
          <img width="200" :src="newsParam.coverImg" alt="">
        </el-form-item>
        <vue-ueditor-wrap
...
<script>
  ...
  import {getNewsById} from '@/api/product'
